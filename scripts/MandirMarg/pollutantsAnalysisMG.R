...
#barplot(table(PollutionType),main = "Pollution Category",xlab ="Categories",ylab = "No. Of Days",las=1, names.arg = c(levels(PollutionType)),ylim = c(0,100),col ="damgorchid4",cex.axis = 0.8,cex.names =0.8)
#box()
...
#boxplot(Concentration~Months,main="Concentration of PM10 : mg Puram",ylim=c(0,1000),las=1,col=c("coral3","aliceblue","brown1"))
